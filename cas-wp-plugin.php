...
function cas_plugin_enqueue_script() {
  if(is_page_template( 'cas-wp-plugin-template.php')){
    ...
    wp_enqueue_script( 'cas-plugin-js', 'http://cas.threecordsstudio.com/wp-content/plugins/cas-wp-plugin/cas-wp-plugin.js?v=2.1', array( 'angular','angular-resource','angular-route','angular-wp-api' ) );   
  }
